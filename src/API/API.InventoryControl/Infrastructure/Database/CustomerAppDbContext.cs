using API.InventoryControl.Feature.Domain.Exemple;
using API.InventoryControl.Infrastructure.Database.Mappings;
using Microsoft.EntityFrameworkCore;

namespace API.InventoryControl.Infrastructure.Database;
