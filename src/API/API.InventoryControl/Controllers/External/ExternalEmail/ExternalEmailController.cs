namespace API.InventoryControl.Controllers.External.ExternalEmail;
using API.InventoryControl.Controllers;

using API.InventoryControl.Feature.External.ExternalEmail.Create;
