...
public class DeleteExempleSubscribe : IConsumer<ExempleConsumer>
{
    private readonly ILogger<DeleteExempleSubscribe> _logger;

    public DeleteExempleSubscribe(ILogger<DeleteExempleSubscribe> logger)
    {
        _logger = logger;
    }
    ...
    {
        _logger.LogInformation("Received Delete Exemple event via MassTransit: {Message}", context.Message);
