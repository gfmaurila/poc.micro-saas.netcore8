...
public class CreateExempleSubscribe : IConsumer<ExempleConsumer>
{
    private readonly ILogger<CreateExempleSubscribe> _logger;

    public CreateExempleSubscribe(ILogger<CreateExempleSubscribe> logger)
    {
        _logger = logger;
    }
    ...
    {
        _logger.LogInformation("Received Create Exemple event via MassTransit: {Message}", context.Message);
