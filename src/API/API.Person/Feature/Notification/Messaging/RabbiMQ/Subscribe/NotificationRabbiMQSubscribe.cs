...
public class NotificationRabbiMQSubscribe : IConsumer<NotificationEvent>
{
    private readonly ILogger<NotificationRabbiMQSubscribe> _logger;

    public NotificationRabbiMQSubscribe(ILogger<NotificationRabbiMQSubscribe> logger)
    {
        _logger = logger;
    }
    ...
    {
        _logger.LogInformation("Received notification event via MassTransit: {Message}", context.Message);
