using API.Customer.Infrastructure.Auth;
using API.Customer.Infrastructure.Database;
using API.Customer.Infrastructure.Database.Repositories;
using API.Customer.Infrastructure.Database.Repositories.Interfaces;
using API.Customer.Infrastructure.Integration;
using API.Customer.Infrastructure.Redis;
using API.Exemple1.Core._08.Infrastructure.Messaging;
using Microsoft.EntityFrameworkCore;
using System.Reflection;

namespace API.Customer.Extensions;
...
public static class InfrastructureExtensions
{
    ...
    public static async Task MigrateAsync(this WebApplication app)
    {
        ...
        await using var writeDbContext = serviceScope.ServiceProvider.GetRequiredService<CustomerAppDbContext>();
    ...
    public static void ApplyMigrations(this IHost app)
    {
        ...
        try
        {
            var context = services.GetRequiredService<CustomerAppDbContext>();
