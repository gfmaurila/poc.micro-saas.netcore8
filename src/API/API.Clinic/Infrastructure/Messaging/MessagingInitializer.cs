using API.Clinic.Feature.Notification.Messaging.Kafka.Subscribe;
using API.Clinic.Feature.Notification.Messaging.RabbiMQ.Subscribe;
using API.Clinic.Infrastructure.Messaging.RabbiMQ;
